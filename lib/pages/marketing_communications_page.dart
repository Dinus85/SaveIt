// lib/pages/marketing_communications_page.dart
...
class MarketingCommunicationsPage extends StatefulWidget {
  final bool isDarkTheme;

  const MarketingCommunicationsPage({Key? key, required this.isDarkTheme}) : super(key: key);

  @override
  _MarketingCommunicationsPageState createState() => _MarketingCommunicationsPageState();
}

class _MarketingCommunicationsPageState extends State<MarketingCommunicationsPage> {
  ...
  Future<void> _loadContent() async {
    ...
    try {
      final content = await _contentService.loadContent('marketing_communications');
      setState(() {
        _content = content;
        _isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        titleSpacing: 16,
        title: Text(
          _content?.title ?? 'Marketing e Comunicazioni',
          style: TextStyle(
          ...
          child: Row(
            ...
            children: [
              ...
              FloatingActionButton(
                ...
                heroTag: "fab_marketing_communications",
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                'Dati profilazione disciplinati nei Termini e Condizioni',
        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'NOTA: Questo documento definisce come gestiamo le comunicazioni marketing. I dati di profilazione per personalizzazione sono disciplinati nei Termini e Condizioni.',
                style: TextStyle(color: Colors.purple, fontSize: 11, fontWeight: FontWeight.w500),
              ),
            ),
          ],
