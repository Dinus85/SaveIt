...
class TermsConditionsPage extends StatefulWidget {
  ...
  const TermsConditionsPage({Key? key, required this.isDarkTheme}) : super(key: key);
...
class _TermsConditionsPageState extends State<TermsConditionsPage> {
  ...
  Future<void> _loadContent() async {
    ...
    try {
      final content = await _contentService.loadContent('terms_conditions');
      setState(() {
        _content = content;
        _isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        titleSpacing: 16,
        title: Text(
          _content?.title ?? 'Termini e Condizioni',
          style: TextStyle(
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'ATTENZIONE: Condizioni di Profilazione Incluse',
              ...
              SizedBox(height: 4),
              Text(
                'I dati di profilazione sono di proprietà esclusiva di SaveIn',
        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'NOTA: Questo documento include clausole di profilazione con acquisizione esclusiva dei dati comportamentali.',
                style: TextStyle(color: Colors.red, fontSize: 11, fontWeight: FontWeight.w500),
              ),
            ),
          ],
