...
Build mobile:
- Versione mobile corrente in repo: `pubspec.yaml` **`1.1.0+57`** (lug 2026). Include Share Extension iOS con salvataggio diretto + enrich IG/TikTok in `savePostFromShare`.
